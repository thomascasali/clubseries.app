...
const Notifications = () => {
  ...
  const handleMarkAsRead = async (notificationId) => {
    try {
      ...
      toast.error(err.message || 'Errore durante la marcatura della notifica');
    }
  };
  ...
  const handleMarkAllAsRead = async () => {
    try {
      ...
      toast.error(err.message || 'Errore durante la marcatura di tutte le notifiche');
    }
  };
  ...
  const handleDeleteNotification = async (notificationId) => {
    try {
      ...
      toast.error(err.message || 'Errore durante l\'eliminazione della notifica');
    }
  };
